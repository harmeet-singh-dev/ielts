    ...
    <JetAuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
             ...
             <div class="mt-4">
                <JetLabel for="institute" value="Institute Name" />
                <JetInput
                    id="institute"
                    ...
                    required
                />
                <JetInputError class="mt-2" :message="form.errors.institute_name" />
            </div>
              ...
              <div class="mt-4">
                ...
                <JetInput
                    ...
                    required
                />
                <JetInputError class="mt-2" :message="form.errors.state" />
            </div>

               <div class="mt-4">
                <JetLabel for="pincode" value="Pincode" />
                <JetInput
                    id="pincode"
                    ...
                    required
                />
                <JetInputError class="mt-2" :message="form.errors.pincode" />
            </div>
